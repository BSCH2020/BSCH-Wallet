...
import { ChainId, Currency, ETHER, Fetcher, Pair, Token, WETH } from "@bschswap/sdk";
...
const BSCH = new Token(ChainId.MAINNET, "0x6B3595068778DD592e39A122f4f5a5cF09C90fE2", 18, "BSCH", "BSCHToken");
...
const BASES_TO_CHECK_TRADES_AGAINST = [WETH[ChainId.MAINNET], WBTC, DAI, USDC, USDT, BSCH, YAM];
const CUSTOM_BASES = {
