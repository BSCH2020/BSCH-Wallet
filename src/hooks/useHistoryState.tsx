...
import { _roundSlotsReward,getBSCHPrice, viewFarmBasicInfo,viewRoundSlot,fetchBtcMiningStat,getTotalRemainingSupplyLocked,viewUserInfo,totalSupplyOfSToken,fetchTotalMinedRTokenInpool, fetchCurrentTotalStakedSTokenInpool,viewTotalRewardInPoolFrom} from "../utils/api-utils";
...
const useHistoryState = () => {
    ...
    const [bschPrice, setBSCHPrice] = useState<number>(0);
    ...
    useAsyncEffect(async () => {
        ...
        try{
            const bschPrice = await getBSCHPrice();
            setBSCHPrice(bschPrice);
        } finally {
