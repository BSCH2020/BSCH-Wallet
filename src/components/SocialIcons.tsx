...
const SocialIcons = () => {
    ...
    const onPressTwitter = useLinker("http://twitter.com/BSCH2020", "", "_blank");
    const onPressGithub = useLinker("https://github.com/Standard-Hashrate-Group", "", "_blank");
    
    const onMedium = useLinker("https://bsch.medium.com/", "", "_blank");
    // const onPressReddit = useLinker("https://www.reddit.com/user/BSCHandardHashrate", "", "_blank");
    const onTg = useLinker("https://t.me/BSCHCommunity","","_blank");
