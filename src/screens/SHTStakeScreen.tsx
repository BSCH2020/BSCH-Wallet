        ...
        <Screen>
            <Container>
                ...
                <Content>
                    ...
                    // +t("or")+" "+t("just-send-to-address")+" "+BSCHFarm
                                    }</Text>
                    <Staking />
                </Content>
...
const Staking = () => {
    ...
    const onPressEx = useLinker("https://www.binance.com/cn/trade/BSCH_USDT", "", "_blank");
    ...
    return (
        <View style={{ marginTop: Spacing.large }}>
            ...
            {state.stoken && state.yourTotalSToken?.isZero() && (
                <View>
                    <Notice text={t("you-dont-have-bsch")} color={"orange"} style={{ marginTop: Spacing.small }} />
        ...
        <View>
            ...
            <Text
                ...
                {loading || !state.stoken || !yourTotalSToken? t("fetching")
                    :t("you-have")+" "+formatBalance(yourTotalSToken, state.stoken.decimals)+" BSCH"
                    }
            </Text>
            <Text
                style={{
